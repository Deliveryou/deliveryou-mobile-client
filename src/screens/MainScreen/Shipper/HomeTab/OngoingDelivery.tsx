    ...
    function openChat() {
        if (deliveryPackage.current && chatSession.current) {
            navigation.navigate('ChatScreen', {
                partner: deliveryPackage.current?.user,
                sessionId: chatSession.current.id
            })
        } else
    ...
    return (
        <View style={[flex_1]}>
            ...
            <ScrollView>
                ...
                />
                <View style={flex_row}>
                    <Text style={mr_10}>Price:</Text>
                    <Text style={flex_1}>12000</Text>
                </View>
            </ScrollView>
